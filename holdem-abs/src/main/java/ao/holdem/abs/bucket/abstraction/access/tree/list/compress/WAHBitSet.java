...
//     *
//     * This operation is considerably slower than the uncompressed version. Use it with care.
...
//
//    /**
//     * Returns an index set for the set bits in the bitset. IndexSet is an easier
//     * way to get the set bits in the compressed bitset. IndexSet is lighter weight
//     * interface than iterator, and should be used when the performance is important.
//     *
...
//     *  the function <tt>isRange</tt> returns true, otherwise it returns false.  If
//     *  isRange returns true, the position of the first bit is pointed by the
//     *  pointer returned by function <tt>indices</tt>, and there are <tt>nIndices</tt>
//     *  consecutive ones.  If <tt>isRange</tt> returns false, there are <tt>nIndices</tt>
//     *  bits that are one and the positions of these bits are stored in the
//     *  array returned by function <tt>indices</tt>.
//     *
...
//            if(range) {
//                ret = (int) range_start ++;
//                if(range_start == range_end) fill();
//            } else {
//                ret = (int) pos[pos_idx++];
//                if(pos_idx == pos.length) fill();
//            }
//
//            return ret;
//        }
